...
def test_get_cached_returns_none_when_empty() -> None:
    """Test get_cached returns None when cache is empty."""
    result = cache.get_cached("rss")
    assert result is None


def test_get_cached_returns_cached_content() -> None:
...
def test_get_cached_returns_none_when_expired() -> None:
...
def test_get_cached_different_types() -> None:
